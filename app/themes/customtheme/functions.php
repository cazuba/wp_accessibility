...
function bootstrap_theme_enqueue_scripts() {
  ...
  // Lined Textarea - SCRIPT
  wp_enqueue_script( 'jquery-linedtextarea-script', $template_url . '/js/jquery-linedtextarea/jquery-linedtextarea.js', array( 'jquery' ), null, true );

  // Lined Textarea - STYLE
  wp_enqueue_style( 'jquery-linedtextarea-style', $template_url. '/js/jquery-linedtextarea/jquery-linedtextarea.css' );
  
  // Lined Textarea
  wp_enqueue_script( 'jquery-script', $template_url . '/js/main.js', array( 'jquery', 'jquery-linedtextarea-script' ), null, true );
